...
public class FarmerInnerScreen {
    ...
    public FarmerInnerScreen(Stage stage, List<Map<String, String>> data) {
        this.stage = stage;
        this.data = data;
    }
    ...
    private void updateDetailsView(int index) {
        ...
        if (nameLabel != null) {
            nameLabel.setText(data1.get("Name"));
        } else {
            System.out.println("nameLabel is null");
        }

        if (locationLabel != null) {
            locationLabel.setText(data1.get("Location") );
        } else {
            System.out.println("locationLabel is null");
        }

        if (priceLabel != null) {
            priceLabel.setText("₹" + data1.get("Salary") );
        } else {
            System.out.println("priceLabel is null");
        }

        if (descriptionLabel != null) {
            descriptionLabel.setText(data1.get("job-title"));
        } else {
        ...
        if (myNameLabel != null){
            myNameLabel.setText(data1.get("job-type"));
        }else{
